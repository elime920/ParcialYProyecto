//exercise 3a setup: parameters, source, boundary and solution
#include <cmath>

#define _USE_MATH_DEFINES

//equation parameters
double xInit = 0.0, xFin = 1.0, yInit = 0.0, yFin = 1.0;
double stepX = 0.2, stepY = 0.2;
...
double boundBVP(unsigned int i, unsigned int j)
{
  ...
  else if (i == xPoints) value = y(j);
  else if (j == yPoints) value = x(i);
